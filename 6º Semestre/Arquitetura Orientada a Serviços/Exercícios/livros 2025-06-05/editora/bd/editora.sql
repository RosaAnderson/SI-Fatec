...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Maio-2025 às 00:26
...
--
ALTER TABLE `autores`
  MODIFY `id_autores` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `livros`
  MODIFY `id_livros` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `livros_autores`
--
ALTER TABLE `livros_autores`
  MODIFY `id_livros_autores` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
