 ...
 * 	          A área é sempre calculada em  centímetro quadrado (cm²), metro quadrado (m²) ou
 * 			  quilômmetro  quadrado (Km²). O  perímetro  é calculado em centímetro (cm), metro (m)
 * 			  ou quilômetro (km).
**/
...
int  main()
{
	...
	printf("\n\n\nPara encontrar a area de um retangulo, e preciso informar \nos valores de base (b) e de altura (h). \n");
