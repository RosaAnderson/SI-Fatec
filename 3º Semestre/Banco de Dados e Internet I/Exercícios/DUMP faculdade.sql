...
insert  into `disciplinas`(`id_disciplina`,`descritivo`,`valor`,`id_curso`,`id_professor`,`cargah`) values (1,'banco de dados I','100.00',1,1,4),(2,'estrutura de dados','200.00',1,1,4),(3,'Ingles','300.00',2,3,2),(4,'Projeto de Graduação','500.00',3,2,2),(5,'Banco de Dados II','250.00',1,1,4),(6,'Topicos em SI - III','300.00',1,2,4),(7,'Cozinha Italiana','250.00',8,9,2),(8,'Calculo I','200.00',9,4,4),(10,'Calculo II','200.00',9,8,4);
