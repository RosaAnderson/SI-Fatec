...
/*1)(rh_empresa) Criar uma procedure que liste 
todos os dependentes de um determinado funcionarios
...
CALL proc_lista_filhos(1);
CALL proc_lista_filhos(20);
CALL proc_lista_filhos(8);

/*2)(fatecvan)Criar uma procedure que liste 
o total vendido por um determinado vendedor.
...
DELIMITER //
DROP PROCEDURE IF EXISTS proc_vendas_vendedor //
CREATE PROCEDURE proc_vendas_vendedor (IN codv INT)
BEGIN
  ## Corpo da procedure
